...
class End_window:
    ...
    def __init__(self, root, win, map_instance):
        ...
        #Create the canvas the images are placed on
        ...
        #Create the a label that show the number of correct answers
        ...
        #Create the a label that show the number of incorrect answers
        self.canvas.create_text(
            7.597900390625,
            152.79571533203125,
            anchor="nw",
        ...
        #Create the a label that show the number of questions answered
        self.canvas.create_text(
            7.597900390625,
            175.79571533203125,
            anchor="nw",
